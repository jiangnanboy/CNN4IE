...
# import sys
# sys.path.append('/home/sy/project/CNN4IE/')

from cnn4ie.mixed_attention_cnn.model import MultiLayerMixedAttCNN
...
class Train():
    ...
    def _define_model(self,
        ...
        :return:
        '''
        model = MultiLayerMixedAttCNN(input_dim,
                                 output_dim,
                                 emb_dim,
                                 hid_dim,
                                 head_num,
    ...
    def train_model(self, config_path):
        if os.path.exists(config_path) and (os.path.split(config_path)[1].split('.')[0] == 'config') and (
            ...
            head_num = config.getint(section, 'head_num')
            head_ratio = config.getint(section, 'head_ratio')
