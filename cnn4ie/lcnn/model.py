...
from cnn4ie.lcnn.lightweight_conv import LightweightConv1dTBC
...
class Encoder(nn.Module):
    def __init__(self, emb_dim, hid_dim, n_layers, kernel_size, dropout):
        ...
        # convolution block
        self.convs = nn.ModuleList([LightweightConv1dTBC(input_size=hid_dim,
...
class MultiLayerResLWCNN(nn.Module):
    def __init__(self, input_dim, output_dim, emb_dim, hid_dim, cnn_layers, encoder_layers, kernel_size, dropout, PAD_IDX, max_length=100, use_crf = True):
        ...
        :param max_length:
        '''
        super(MultiLayerResLWCNN, self).__init__()
