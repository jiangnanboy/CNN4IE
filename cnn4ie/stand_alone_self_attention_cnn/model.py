...
from cnn4ie.stand_alone_self_attention_cnn.stand_alone_self_attention import AttentionConv
...
class Encoder(nn.Module):
    def __init__(self, emb_dim, hid_dim, n_layers, kernel_size, dropout):
        ...
        # convolution block
        self.convs = nn.ModuleList([AttentionConv(in_channels=hid_dim,
...
class MultiLayerStdAttnCNN(nn.Module):
    def __init__(self, input_dim, output_dim, emb_dim, hid_dim, cnn_layers, encoder_layers, kernel_size, dropout, PAD_IDX, max_length=100, use_crf = True):
        ...
        :param use_crf:
        '''
        super(MultiLayerStdAttnCNN, self).__init__()
