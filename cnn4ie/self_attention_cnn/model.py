...
from cnn4ie.self_attention_cnn.self_attention_conv import SelfAttention
...
class Encoder(nn.Module):
    def __init__(self, emb_dim, hid_dim, n_layers, kernel_size, dropout):
        ...
        # convolution block
        self.convs = nn.ModuleList([SelfAttention(in_channels=hid_dim,
...
class MultiLayerSACNN(nn.Module):
    def __init__(self, input_dim, output_dim, emb_dim, hid_dim, cnn_layers, encoder_layers, kernel_size, dropout, PAD_IDX, max_length=100, use_crf = True):
        ...
        :param max_length:
        '''
        super(MultiLayerSACNN, self).__init__()
